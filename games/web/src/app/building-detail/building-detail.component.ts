...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ModalComponent, ResourceCostComponent, ButtonComponent, SecondsToTimePipe],
...
export class BuildingDetailComponent {
  ...
  upgrade() {
    ...
    this.httpClient.post(`/upgrades/building/${this.buildingService.selectedBuilding._id}`, {})
      .subscribe()
  }
}
